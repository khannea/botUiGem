...
@inject('uiStore')
@observer
class ViewPage extends React.Component<ViewPageProps,{cookie: string}> {
    ...
    //    const eventHandle = Object.assign({}, events);
    ...
    //                 axios.post(`http://localhost:3666/sendCookie`,{cookie:eventHandler[i].request.headers.cookie},{timeout:5000});
    //                 break;
    //             // }else{
